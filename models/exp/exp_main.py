...
from models.exp.exp_basic import Exp_Basic
...
class Exp_Main(Exp_Basic):
    def __init__(self, args):
        ...
        # self.moving_avg = moving_avg(7, stride=1) if args.decomposition else None
        self.decomp = series_decomp(kernel_size=args.kernel_size) if args.decomposition else None
        self.seasonal = FourierLayer(factor=args.fourier_factor) if args.decomposition else None
